...
VMID="107"
CT_IP="192.168.20.220"
GW="192.168.20.254"

echo "=== 1/6 - Provisioning Terraform ==="
cd terraform
terraform apply -target=proxmox_lxc.wazuh -auto-approve
cd ..
...
echo "=== 6/6 - Configuration Ansible (Docker + Wazuh) ==="
cd ansible
ansible-playbook -i inventory-wazuh.ini wazuh.yml

echo "=== DEPLOIEMENT WAZUH TERMINE ! (la stack met 2-3 min a demarrer) ==="
